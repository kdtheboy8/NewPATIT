 ...
 * @author kudamlambo
 */
public class TPinSAHistoryNotesG9 extends javax.swing.JFrame
{
     UserDetails userDetails ;
    /**
     * Creates new form IndustrialRevolution
     */
    public TPinSAHistoryNotesG9() 
    {
    ...
    private void BtnReadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnReadActionPerformed
        ...
        String fileName = "Turning Points in South African History (1960, 1976, and 1990) G9.txt";
    ...
    private void BtnModifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnModifyActionPerformed
         ...
         if (userDetails != null && "Teacher".equals(userDetails.getRole())) 
         {
             //Allow teacher to modify notes displayed in text area
